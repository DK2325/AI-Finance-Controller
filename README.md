...
| Metric | Value |
|---|---|
| Auto-match rate (coverage) | 50.50% |
| Precision on auto-matched | 99.96% (95% CI 99.77%-99.99%, 1 false in 2,497) |
| Recall of true links | 50.48% |
| Money-weighted precision | 99.9863% |
| Money error ratio (Rs wrong / Rs at stake) | 0.0069% |
| Orphan refusal rate | 100.00% |
| Rs at stake | 395,349,148.43 |
| Rs incorrectly matched | 27,372.50 |
| False auto-matches | 1 |
