...
| Metric | Value |
|---|---|
| Auto-match rate (coverage) | 51.71% |
| Precision on auto-matched | 97.85% |
| Recall of true links | 50.60% |
| Money-weighted precision | 97.9156% |
| Money error ratio (Rs wrong / Rs at stake) | 1.0762% |
| Orphan refusal rate | 100.00% |
| Rs at stake | 1,238,638,515.49 |
| Rs incorrectly matched | 13,330,830.44 |
| False auto-matches | 55 |
...
|---|---|---|---|---|
| `batched_settlement` | 658 | 336 | 322 | 0 |
| `clean` | 3023 | 1530 | 1493 | 0 |
| `date_skew` | 165 | 86 | 79 | 0 |
| `duplicate_utr` | 110 | 55 | 55 | 0 |
| `fee_deducted` | 549 | 276 | 273 | 0 |
| `orphan` | 55 | 0 | 0 | 55 |
| `partial_payment` | 330 | 166 | 164 | 0 |
| `rounding_drift` | 110 | 53 | 57 | 0 |
<!-- METRICS:END -->
