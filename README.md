...
| Metric | Value |
|---|---|
| Auto-match rate (coverage) | 65.48% |
| Precision on auto-matched | 99.94% |
| Recall of true links | 65.44% |
| Money-weighted precision | 99.9776% |
| Money error ratio (Rs wrong / Rs at stake) | 0.0145% |
| Orphan refusal rate | 100.00% |
| Rs at stake | 395,349,148.43 |
| Rs incorrectly matched | 57,372.50 |
| False auto-matches | 2 |
...
|---|---|---|---|---|
| `batched_settlement` | 659 | 176 | 483 | 0 |
| `clean` | 3022 | 2204 | 818 | 0 |
| `date_skew` | 165 | 85 | 80 | 0 |
| `duplicate_utr` | 110 | 83 | 27 | 0 |
| `fee_deducted` | 549 | 405 | 144 | 0 |
| `orphan` | 55 | 0 | 0 | 55 |
| `partial_payment` | 330 | 225 | 105 | 0 |
| `rounding_drift` | 110 | 58 | 52 | 0 |
<!-- METRICS:END -->
